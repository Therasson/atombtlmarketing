                    ...
                    <div class="class-body">
                        <form>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="name" type="text" class="form-control" v-model="name" required autofocus autocomplete="off" placeholder="Enter your email">
                                </div>
                            </div>
                            ...
                            <div class="row mt-1">
                                <div class="col-md-8 offset-md-4">
                                    <small class="text-muted">
                                        Have an account? please <router-link to="/login">Login</router-link>
                                    </small>
                                </div>
                            </div>
                        </form>
